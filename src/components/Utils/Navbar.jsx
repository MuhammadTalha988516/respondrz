...
const Navbar = () => {
  ...
  return (
    <div className=" flex items-center h-[100px] px-8 relative z-[2000]">
      {/* Left Logo */}
        ...
        >
          <div className="p-8 grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li>
                  <Link
                    to="/about/overview"
                    className="hover:text-[#F34434]"
                  >
                    Company Overview
                  </Link>
                </li>
                <li>
                  <Link to="/about/mission" className="hover:text-[#F34434]">
                    Mission & Vision
                  </Link>
                </li>
                <li>
                  <Link to="/about/values" className="hover:text-[#F34434]">
                    Core Values
                  </Link>
                </li>
                <li>
                  <Link to="/about/news" className="hover:text-[#F34434]">
                    News & Updates
                  </Link>
                </li>
              </ul>
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li>
                  <Link to="/about/team" className="hover:text-[#F34434]">
                    Our Team
                  </Link>
                </li>
                <li>
                  <Link to="/about/careers" className="hover:text-[#F34434]">
                    Careers
                  </Link>
                </li>
                <li>
                  <Link to="/about/partners" className="hover:text-[#F34434]">
                    Partners
                  </Link>
                </li>
                <li>
                  <Link to="/about/contact" className="hover:text-[#F34434]">
                    Contact
                  </Link>
                </li>
              </ul>
        ...
        >
          <div className="p-8 grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li>
                  <Link to="/contact/phone" className="hover:text-[#F34434]">
                    Phone Support
                  </Link>
                </li>
                <li>
                  <Link to="/contact/email" className="hover:text-[#F34434]">
                    Email
                  </Link>
                </li>
                <li>
                  <Link to="/contact/office" className="hover:text-[#F34434]">
                    Office Locations
                  </Link>
                </li>
                <li>
                  <Link to="/contact/help" className="hover:text-[#F34434]">
                    Help Center
                  </Link>
                </li>
              </ul>
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li>
                  <Link to="/contact/report" className="hover:text-[#F34434]">
                    Report Emergency
                  </Link>
                </li>
                <li>
                  <Link to="/contact/feedback" className="hover:text-[#F34434]">
                    Feedback
                  </Link>
                </li>
                <li>
                  <Link to="/contact/partners" className="hover:text-[#F34434]">
                    Partner With Us
                  </Link>
                </li>
                <li>
                  <Link to="/contact/careers" className="hover:text-[#F34434]">
                    Careers
                  </Link>
                </li>
              </ul>
