...
const AmbulanceService = () => {
  ...
  return (
    <section className="w-full py-16 md:py-20 bg-gradient-to-b from-red-50 to-white">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        {/* Heading */}
        <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-[#F34434] mb-4">
        ...
        <div className="mt-10 sm:mt-12 flex justify-center">
          <motion.div
            ...
            className="w-full max-w-3xl bg-white shadow-2xl rounded-2xl p-6 sm:p-8 border border-gray-200"
          >
            {/* Icon + Title */}
            <div className="flex flex-col sm:flex-row items-center justify-center gap-3 mb-4">
              <div className="bg-[#F34434]/10 p-3 sm:p-4 rounded-full">
                <Ambulance size={32} className="sm:size-40 text-[#F34434]" />
              </div>
            ...
            <AnimatePresence>
              {open && (
                <motion.div
                  ...
                  className="mt-6 text-left space-y-4 text-gray-700 text-sm sm:text-base"
                >
                  <p>
            ...
            <div className="mt-6 sm:mt-8 flex justify-center">
              <a
                href="/join-provider"
                className="inline-flex items-center gap-2 bg-[#F34434] text-white px-6 sm:px-8 py-3 sm:py-4 rounded-2xl font-bold shadow hover:bg-[#d92f2f] transition text-sm sm:text-base"
              >
                🚑 Join as Provider
              </a>
            </div>
