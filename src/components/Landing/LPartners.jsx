...
const PARTNERS_DATA = [
  {
    ...
    bg: "https://img.dunyanews.tv/news/2025/March/03-10-25/news_big_images/872446_85694817.webp",
  },
  {
    id: "02",
    ...
    bg: "https://edhi.org/wp-content/uploads/2016/12/Ambulance-Service.webp",
  },
  {
    id: "03",
    ...
    bg: "https://images.pexels.com/photos/3184338/pexels-photo-3184338.webp",
  },
  {
    id: "04",
    ...
    bg: "https://wfumb.info/wp-content/uploads/2019/01/Kenya_AKU_Kenya_0284.webp",
  },
  {
    id: "05",
    ...
    bg: "https://images.pexels.com/photos/33568993/pexels-photo-33568993.webp",
  },
  {
    id: "06",
    ...
    bg: "https://images.pexels.com/photos/7163955/pexels-photo-7163955.webp",
  },
];
...
const PartnerCard = ({ id, title, subtitle, desc, bg }) => (
  <div
    className="w-[340px] h-[460px] flex flex-col rounded-xl shadow-xl shrink-0 relative overflow-hidden group"
    style={{
  ...
  >
    ...
    <div className="absolute bottom-0 left-0 w-full p-6 z-10 text-center opacity-0 translate-y-8 group-hover:opacity-100 group-hover:translate-y-0 transition-all duration-500">
...
const LPartners = () => {
  ...
  return (
    <>
      ...
      {/* Horizontal Scroll */}
      <section ref={containerRef} className="relative w-full h-[350vh] bg-gray-300">
        <div className="sticky top-0 h-screen flex items-center overflow-hidden">
          <motion.div className="flex items-center gap-10" style={{ x: scrollX }}>
      ...
      <motion.section
        className="w-full py-32 bg-gray-300"
