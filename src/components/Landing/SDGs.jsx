  ...
  return (
    <div className="w-full h-auto flex flex-col items-center space-y-10 py-12 px-4">
      ...
      <div className="text-center max-w-2xl space-y-4">
        ...
        <Link 
          to="/impact" 
          className="inline-flex items-center gap-2 bg-[#F34434] text-white font-semibold px-6 py-4 mt-2 rounded-lg shadow-md hover:bg-red-600 transition duration-300"
        >
